...
ssh root@192.168.1.33 "mount /dev/mmcblk0p1 mntdir"
scp arch/arm/boot/zImage root@192.168.1.33:/root/mntdir/
scp arch/arm/boot/dts/micile-A33G6.dtb root@192.168.1.33:/root/mntdir/micile.dtb
...
ssh root@192.168.1.33 "umount mntdir"

#tar -C lib_kernel -cf - ./lib/ | ssh root@192.168.1.16 "tar -C / -xf -"

ssh root@192.168.1.33 "reboot"
